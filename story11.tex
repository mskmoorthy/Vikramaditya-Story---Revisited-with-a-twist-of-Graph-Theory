...
Rishnak wanted to test Ajur's understanding. He said that in olden days temples are constructed in road junctions of a Royt village. He asked Ajur, what will be the smallest number of temples that had to be constructed in the following Figure \ref{13g6} which shows the road map of Royt so that there is at least temple at either end of each edge..
\begin{figure}
\begin{center}
...
Ajur was mesmerized by the beautiful layout of Royt village. It looked so symmetric. Ajur was tentative in his answer and he said that he would construct just 5 temples in vertices 11, 3, 7, 8 and 1.   asked by Rishnak asked Ajur how he found so quickly. Ajur responded by saying that he tried to find a minimum vertex cover for the Figure \ref{13g6} and he knew that will satisfy the temple eequirements.
