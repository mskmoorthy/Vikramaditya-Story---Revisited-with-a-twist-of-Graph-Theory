...
\textbf{Question for sixteenth day:} Rishnak asked Ajur to find the vertices where a water fountain be placed so that at every vertex has a water fountain adjacent to it for the following graph Figure \ref{18q1}? 
