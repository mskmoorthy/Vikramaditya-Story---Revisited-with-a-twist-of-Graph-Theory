...
\\
\noindent
Rishnak laughed and said that the subgraph you drew is called an \textit {induced subgraph} --- that is, all the edges are included in the vertex subset. You have the flexibility of choosing only a subset of these edges. But for all the chosen subset of edges, end vertices should be in the chosen vertex subset. 
\\
\begin{figure}
\begin{center}
\begin{tikzpicture}
