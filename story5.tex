...
Ajur was able to follow along and loved the subtle and the clever arguments used in the proof. 
 ...
 \textbf{Question for the fifth day:} Rishnak asked Ajur if there is a Hamiltonian path in a complete bi-partite graph $K_{2,4}$ i.e., Verices 1 and 2 are adjacent to all the vertices 3, 4, 5 and 6 and there are no other edge. 
