...
\textbf{Question for the first day:} Rishnak asked Ajur if there is a degree sequence that is the degree sequence of only one graph? Rishnak added that you can ignore the labels on vertices.
