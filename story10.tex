...
\textbf{Answer:} Ajur thought if the wight of the edge 5 to 4 is increased to 1000, then the shortest path is forced to go through vertex 3 as shown the following Figure \ref{12qa1}
