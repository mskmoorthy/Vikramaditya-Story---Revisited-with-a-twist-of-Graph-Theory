...
\textbf{Question for the seventh day:} Draw a planar embedding for a complete bi-partite graph $K_{2,3}$.

\textbf{Answer:} Ajur drew the embedding of $K_{2,3}$ in Figure \ref{7a1}
\begin{figure}
\begin{center}
\begin{tikzpicture}
  [scale=.5,auto=left,every node/.style={circle,fill=red!20}]
 ...
 \foreach \from/\to in {n1/n3,n1/n4,n1/n5,n2/n3,n2/n4,n2/n5}
    \draw (\from) -- (\to);
\end{tikzpicture}
\caption{ Planar drawing of $K_{2,3}$}\label{7a1}
\end{center}
\end{figure}
