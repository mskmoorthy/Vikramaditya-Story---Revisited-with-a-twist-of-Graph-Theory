...
Rishank was very impressed with Urpur's thinking. Sensing that Ajur was feeling jealous that Urpur was grabbing his attention,
...
1 and 14 of the edges have weight 10. which of edges have which weights to answer the
following  two questions: (Just show the edges whose weight is 1.)
\begin{enumerate}
...
\textbf{Answer:} Ajur could do the first part easily if there is a cycle of length 8, with edge weigth being 1, the minimum spanning tree cost will be 7.

Ajur thought the second problem is a bit more challenging. To get the maximum weight, all edges incident on a vertex has to be of of weight 10. That is possible with only two vertices. Hence the maximum weight the minimum spanning tree can have will be 25.
